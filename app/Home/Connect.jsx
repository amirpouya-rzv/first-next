...
function page() {
  ...
  return (
    <div>
      <div
      className=' md:flex  md:items-center md:gap-36 mx-10 mt-20 md:pl-44 py-24 rounded-xl md:max-w-screen-xl h-full bg-gradient-to-tr  from-[#23202A] via-green-400 to-[#1E1B24]'>
